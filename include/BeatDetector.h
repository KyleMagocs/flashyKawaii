...
uint32_t enablePlot=true;      //flag to set/unset when doing beat detection to enable serial plot only for freq range specified in one of the three variables above.
